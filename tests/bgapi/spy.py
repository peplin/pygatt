...
class BGAPIBackendSpy(object):
    ...
    def stage_run_packets(self, connection_handle=0x00):
        ...
        self.backend._ser.stage_output(BGAPIPacketBuilder.gap_set_mode(0x0000))
    ...
    def stage_connect_packets(self, addr, flags, connection_handle=0x00):
        ...
        self.backend._ser.stage_output(BGAPIPacketBuilder.connection_status(
    ...
    def stage_encrypt_packets(self, addr, flags,
        ...
        self.backend._ser.stage_output(BGAPIPacketBuilder.sm_encrypt_start(
            connection_handle, 0x0000))
        # Stage ble_evt_connection_status
        flags_byte = self._get_connection_status_flags_byte(flags)
        self.backend._ser.stage_output(BGAPIPacketBuilder.connection_status(
    ...
    def stage_bond_packets(self, addr, flags,
        ...
        self.backend._ser.stage_output(BGAPIPacketBuilder.sm_bond_status(
    ...
    def stage_scan_packets(self, scan_responses=[]):
        ...
        for srp in scan_responses:
            ...
            self.backend._ser.stage_output(BGAPIPacketBuilder.gap_scan_response(
    ...
    def stage_subscribe_packets(self, uuid_char, handle_char,
        ...
        if indications:
            ...
            value = [0x01, 0x00]
        self.stage_char_write_packets(handle, value,
